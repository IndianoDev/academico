    ...
    <>
      <ScrollView style={{ margin: 15 }}>
        ...
        <TextInput style={{ marginTop: 10 }}
         ...
         value={dados.cpf}></TextInput>
        <TextInput style={{ marginTop: 10 }} 
        label='Matricula' 
        mode='outlined' 
        onChangeText={(valor) => handlechange(valor, 'matricula')} 
        value={dados.matricula}></TextInput>

        <TextInput style={{ marginTop: 10 }} 
        label='E-mail' 
        mode='outlined'
        onChangeText={(valor) => handlechange(valor, 'e-mail')} 
        value={dados.email}></TextInput>

        <TextInput style={{ marginTop: 10 }} 
        label='Telefone' 
        mode='outlined' 
        onChangeText={(valor) => handlechange(valor, 'telefone')} 
        value={dados.telefone}></TextInput>

        <TextInput style={{ marginTop: 10 }} 
        label='CEP' mode='outlined' 
        onChangeText={(valor) => handlechange(valor, 'cep')} 
        value={dados.cep}></TextInput>

        <TextInput style={{ marginTop: 10 }} 
        label='Logradouro' 
        mode='outlined' 
        onChangeText={(valor) => handlechange(valor, 'logradouro')} 
        value={dados.logradouro}></TextInput>

        <TextInput style={{ marginTop: 10 }} 
        label='Complemento' 
        mode='outlined' 
        onChangeText={(valor) => handlechange(valor, 'complemento')} 
        value={dados.complemento}></TextInput>

        <TextInput style={{ marginTop: 10 }} 
        label='Número'
        mode='outlined' 
        onChangeText={(valor) => handlechange(valor, 'numero')} 
        value={dados.numero}></TextInput>

        <TextInput style={{ marginTop: 10 }} 
        label='Bairro' 
        mode='outlined' 
        onChangeText={(valor) => handlechange(valor, 'bairro')} 
        value={dados.bairro}></TextInput>
